...
const Index = () => {
  ...
  // Featured games for sidebar
  const featuredGames = [
    { id: 1, title: "Epic Savings", image: "/placeholder.svg" },
    { id: 2, title: "Black Myth: Wukong", image: "/placeholder.svg" },
    { id: 3, title: "Stellar Blade", image: "/placeholder.svg" },
    { id: 4, title: "Borderlands 4", image: "/placeholder.svg" },
    { id: 5, title: "Bloodstained: The Scarlet Engagement", image: "/placeholder.svg" },
    { id: 6, title: "Dead by Daylight: Five Nights at Freddy's", image: "/placeholder.svg" }
  ];
                ...
                <div className="relative h-96 md:h-[500px] overflow-hidden rounded-xl bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <p className="text-sm mb-2 opacity-90">JUNE 19 - JULY 3</p>
                  ...
                  <div className="absolute bottom-16 left-32 w-14 h-14 bg-blue-400 rounded-lg transform -rotate-12 opacity-75"></div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  {featuredGames.map((game) => (
                    <Link 
                      key={game.id} 
                      to={`/game/${game.id}`}
                      className="block bg-card-gradient rounded-lg overflow-hidden hover:scale-105 transition-transform duration-200"
                    >
